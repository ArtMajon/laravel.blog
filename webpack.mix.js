...
mix.copyDirectory('resources/assets/admin/plugins/ckeditor5', 'public/assets/admin');
mix.copyDirectory('resources/assets/admin/plugins/ckfinder', 'public/assets/admin');
